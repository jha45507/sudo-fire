    ...
    return (
        <div className='w-[100%]'>
            ...
            <div id="CL" className='flex justify-around items-center my-32 flex-col lg:flex-row px-8 lg:px-0'>
                <img src="images/services/DC-cc.png" className="w-[40%] md:w-[15%]" />
            ...
            <div id="CA" className='flex justify-around items-center my-32 flex-col lg:flex-row px-8 lg:px-0'>
                <img src="images/services/DC-ca.png" className="w-[40%] md:w-[15%] lg:hidden block" />
                ...
                <img src="images/services/DC-ca.png" className="w-[15%] hidden lg:block" />
            </div>

            <div id="CO" className='flex justify-around items-center my-32 flex-col lg:flex-row px-8 lg:px-0'>
                <img src="images/services/DC-co.png" className="w-[40%] md:w-[15%]" />
                <div className="lg:w-[40%] w-full">
            ...
            <div id="M&S" className='flex justify-around items-center my-32 flex-col lg:flex-row px-8 lg:px-0'>
                <img src="images/services/DC-ms.png" className="md:w-[18%] w-[40%] lg:hidden block" />
                ...
                <img src="images/services/DC-ms.png" className="w-[18%] hidden lg:block" />
            </div>
            ...
            <div className="my-32">
                ...
                <div className="flex justify-around items-center my-20 flex-col lg:flex-row space-y-20 lg:space-y-0">
                    ...
                    <div className="flex flex-col justify-center items-center lg:w-[32%] w-[75%] space-y-3">
                        <img src="images/services/DC-aes.png" className="lg:w-[40%] md:w-[25%] w-[35%]" />
                    ...
                    <div className="flex flex-col justify-center items-center lg:w-[32%] w-[75%] space-y-3">
                        <img src="images/services/DC-past.png" className="lg:w-[20%] md:w-[15%] w-[20%]" />
                ...
                <div className='flex justify-around items-center my-20 flex-col lg:flex-row space-y-20 lg:space-y-0'>
                    ...
                    <div className="flex flex-col justify-start items-center lg:w-[25%] w-[75%] space-y-3">
                        <img src="images/services/DC-ac.png" className="lg:w-[40%] md:w-[30%] w-[40%]" />
                    ...
                    <div className="flex flex-col justify-start items-center lg:w-[25%] w-[75%] space-y-3">
                        <img src="images/services/DC-pms.png" className="lg:w-[40%] md:w-[30%] w-[40%]" />
